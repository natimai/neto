...
LOCATIONS = [
    ...
    {
        "slug": "מתקין-מזגנים-שדרות",
        "city": "שדרות",
        "prep": "בשדרות",
        "intro": [
            "מיזוג נטו מספקת שירותי מכירה, התקנה והקמת מערכות מיזוג אוויר בשדרות ובסביבה. עם מעל 30 שנות ניסיון בדרום, אנחנו מתקינים מזגנים לבתים פרטיים, דירות ועסקים במחירים הוגנים ובאמינות מלאה.",
            "אנחנו מתקינים מזגנים עיליים, מיני מרכזי ומערכות VRF מכל המותגים, כולל עבודות גבס מלאות, בעבודה נקייה ומדויקת.",
        ],
        "faq": [
            ("אתם מגיעים לשדרות?",
             "כן, שדרות והיישובים בעוטף נמצאים באזור השירות שלנו ואנחנו מגיעים אליהם באופן שוטף."),
            ("אתם מתקינים גם לעסקים?",
             "בהחלט, אנחנו מבצעים התקנות והקמות מיזוג לבתים פרטיים, לדירות ולעסקים."),
            ("אפשר לקבל הצעת מחיר?",
             "כן, אנחנו מגיעים לביקור חינם ומספקים הצעת מחיר שקופה ומפורטת מראש."),
        ],
    },
    {
        "slug": "מתקין-מזגנים-ערד",
        "city": "ערד",
        "prep": "בערד",
        "intro": [
            "בערד, עם האקלים המדברי היבש, מערכת מיזוג יעילה היא חיונית. מיזוג נטו מתמחה במכירה, התקנה והקמת מערכות מיזוג אוויר בערד ובסביבה, עם דגש על מערכות חזקות וחסכוניות.",
            "מהתקנת מזגן עילי בודד ועד הקמת מערכת מיזוג קומפלט לבית שלם, כולל עבודות גבס – הכל תחת קבלן אחד ובמחיר הוגן.",
        ],
        "faq": [
            ("אתם מגיעים לערד?",
             "כן, ערד נמצאת באזור השירות שלנו ואנחנו מגיעים אליה להתקנה והקמת מערכות מיזוג."),
            ("איזו מערכת מתאימה לאקלים של ערד?",
             "לאזור המדברי מומלצות מערכות בעלות תפוקת קירור גבוהה ודירוג אנרגטי טוב, ובביקור החינם נמליץ על הפתרון המתאים."),
            ("יש אחריות?",
             "כן, אנחנו מעניקים אחריות מלאה על העבודה ועל החלפים לתקופה ארוכה."),
        ],
    },
    {
        "slug": "מתקין-מזגנים-רהט",
        "city": "רהט",
        "prep": "ברהט",
        "intro": [
            "מיזוג נטו מתקינה ומקימה מערכות מיזוג אוויר ברהט ובסביבה, לבתים פרטיים ולעסקים. בהנהלת בני הדר ועם מעל 30 שנות ניסיון, אנחנו מספקים שירות מקצועי ואמין במחירים הוגנים.",
            "אנחנו מתאימים לכל בית את המערכת האידיאלית – מזגן עילי, מיני מרכזי או VRF – ומבצעים את כל עבודות הגבס בעצמנו, לתוצאה נקייה שמחזיקה שנים.",
        ],
        "faq": [
            ("אתם נותנים שירות ברהט?",
             "כן, רהט נמצאת באזור השירות הקבוע שלנו ואנחנו מגיעים אליה באופן שוטף."),
            ("אילו מערכות אתם מתקינים?",
             "מזגנים עיליים, מיני מרכזי ומערכות VRF מכל המותגים המובילים, כולל עבודות גבס."),
            ("אפשר לתאם ביקור?",
             "כן, צרו קשר בוואטסאפ או בטלפון ונתאם ביקור וייעוץ ראשוני חינם."),
    ...
    {
        "slug": "מתקין-מזגנים-ירוחם",
        "city": "ירוחם",
        "prep": "בירוחם",
        "intro": [
            "מיזוג נטו מספקת שירותי מכירה, התקנה והקמת מערכות מיזוג אוויר בירוחם ובסביבה. אנחנו מתקינים מזגנים לבתים פרטיים, דירות ועסקים, במחירים הוגנים ובאמינות מלאה.",
            "מהתייעצות ובחירת הציוד ועד התקנה, עבודות גבס והפעלה – אנחנו מלווים אתכם לאורך כל הדרך, עם התחייבות לעבודה נקייה וללוחות זמנים מדויקים.",
        ],
        "faq": [
            ("אתם מגיעים לירוחם?",
             "כן, ירוחם נמצאת באזור השירות שלנו ואנחנו מגיעים אליה להתקנה והקמת מערכות מיזוג."),
            ("כמה עולה התקנת מזגן?",
             "המחיר נקבע לפי סוג המזגן ומורכבות ההתקנה. אנחנו מגיעים לביקור חינם ומספקים הצעת מחיר מפורטת מראש."),
            ("אתם מתקינים מערכות VRF?",
             "כן, אנחנו מומחים בהתקנת מערכות VRF מתקדמות לבתים גדולים ולעסקים."),
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P2C3XGW2"
